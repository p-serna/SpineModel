...
#define q q_caL
 double q = 13;
#define tadj tadj_caL
 double tadj = 0;
#define temp temp_caL
 double temp = 22;
#define th th_caL
 double th = 5;
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 caL /home/pablo/trabajo/Paris/HBP_project/DendriticSpine_N/mod/x86_64/caL3d.mod\n");
