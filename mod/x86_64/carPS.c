...
#define nrn_init _nrn_init__carPS
#define _nrn_initial _nrn_initial__carPS
#define nrn_cur _nrn_cur__carPS
#define _nrn_current _nrn_current__carPS
#define nrn_jacob _nrn_jacob__carPS
#define nrn_state _nrn_state__carPS
#define _net_receive _net_receive__carPS 
#define _f_settables _f_settables__carPS 
#define settables settables__carPS 
#define states states__carPS 
...
extern Memb_func* memb_func;
 ...
 "setdata_carPS", _hoc_setdata,
 "efun_carPS", _hoc_efun,
 "ghk_carPS", _hoc_ghk,
 "htau_carPS", _hoc_htau,
 "settables_carPS", _hoc_settables,
 "table_htau_carPS", _hoc_table_htau,
 0, 0
};
#define efun efun_carPS
#define ghk ghk_carPS
#define htau htau_carPS
#define table_htau table_htau_carPS
...
#define hshift hshift_carPS
 double hshift = 0;
#define hslope hslope_carPS
 double hslope = 17;
#define hvhalf hvhalf_carPS
 double hvhalf = -33.3;
#define mshift mshift_carPS
 double mshift = 0;
#define mtau mtau_carPS
 double mtau = 5.1;
#define mslope mslope_carPS
 double mslope = -6.6;
#define mvhalf mvhalf_carPS
 double mvhalf = -10.3;
#define qfact qfact_carPS
 double qfact = 3;
#define usetable usetable_carPS
 double usetable = 1;
 ...
 "mvhalf_carPS", &mvhalf_carPS,
 "mslope_carPS", &mslope_carPS,
 "mtau_carPS", &mtau_carPS,
 "mshift_carPS", &mshift_carPS,
 "hvhalf_carPS", &hvhalf_carPS,
 "hslope_carPS", &hslope_carPS,
 "hshift_carPS", &hshift_carPS,
 "qfact_carPS", &qfact_carPS,
 "usetable_carPS", &usetable_carPS,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 carPS /export/home1/users/bssn/serna/HBP/SpineModel/mod/x86_64/carPS.mod\n");
