...
#define nrn_init _nrn_init__caL13PS
#define _nrn_initial _nrn_initial__caL13PS
#define nrn_cur _nrn_cur__caL13PS
#define _nrn_current _nrn_current__caL13PS
#define nrn_jacob _nrn_jacob__caL13PS
#define nrn_state _nrn_state__caL13PS
#define _net_receive _net_receive__caL13PS 
#define _f_settables _f_settables__caL13PS 
#define settables settables__caL13PS 
#define states states__caL13PS 
...
extern Memb_func* memb_func;
 ...
 "setdata_caL13PS", _hoc_setdata,
 "efun_caL13PS", _hoc_efun,
 "ghk_caL13PS", _hoc_ghk,
 "settables_caL13PS", _hoc_settables,
 0, 0
};
#define efun efun_caL13PS
#define ghk ghk_caL13PS
...
#define cpr cpr_caL13PS
 double cpr = 0.99;
#define c c_caL13PS
 double c = 0.0398;
#define htau htau_caL13PS
 double htau = 44.3;
#define hslope hslope_caL13PS
 double hslope = 11.9;
#define hvhalf hvhalf_caL13PS
 double hvhalf = -13.4;
#define kpr kpr_caL13PS
 double kpr = 31.4;
#define k k_caL13PS
 double k = 9.005;
#define mslope mslope_caL13PS
 double mslope = -6.7;
#define mvhalf mvhalf_caL13PS
 double mvhalf = -33;
#define usetable usetable_caL13PS
 double usetable = 1;
#define vm vm_caL13PS
 double vm = -8.124;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 "usetable_caL13PS", 0, 1,
 0,0,0
};
 ...
 "mvhalf_caL13PS", &mvhalf_caL13PS,
 "mslope_caL13PS", &mslope_caL13PS,
 "vm_caL13PS", &vm_caL13PS,
 "k_caL13PS", &k_caL13PS,
 "kpr_caL13PS", &kpr_caL13PS,
 "c_caL13PS", &c_caL13PS,
 "cpr_caL13PS", &cpr_caL13PS,
 "hvhalf_caL13PS", &hvhalf_caL13PS,
 "hslope_caL13PS", &hslope_caL13PS,
 "htau_caL13PS", &htau_caL13PS,
 "usetable_caL13PS", &usetable_caL13PS,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 caL13PS /export/home1/users/bssn/serna/HBP/SpineModel/mod/x86_64/caL13PS.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ica = ghk ( _threadargscomma_ v , cai , cao ) * pbar * m * m * h ;
   }
 _current += ica;
