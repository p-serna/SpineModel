...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
 	...
 	ivoc_help("help ?1 kaf /export/home1/users/bssn/serna/HBP/SpineModel/mod/x86_64/kaf.mod\n");
...
static int _reset;
static char *modelname = "Fast A-type Potassium current for nucleus accumbens (Kv4.2)";
