...
#define nrn_init _nrn_init__caLPS
#define _nrn_initial _nrn_initial__caLPS
#define nrn_cur _nrn_cur__caLPS
#define _nrn_current _nrn_current__caLPS
#define nrn_jacob _nrn_jacob__caLPS
#define nrn_state _nrn_state__caLPS
#define _net_receive _net_receive__caLPS 
#define _f_settables _f_settables__caLPS 
#define settables settables__caLPS 
#define states states__caLPS 
...
extern Memb_func* memb_func;
 ...
 "setdata_caLPS", _hoc_setdata,
 "efun_caLPS", _hoc_efun,
 "ghk_caLPS", _hoc_ghk,
 "settables_caLPS", _hoc_settables,
 0, 0
};
#define efun efun_caLPS
#define ghk ghk_caLPS
...
#define a a_caLPS
 double a = 0.17;
#define cpr cpr_caLPS
 double cpr = 0.99;
#define c c_caLPS
 double c = 0.0398;
#define htau htau_caLPS
 double htau = 44.3;
#define hslope hslope_caLPS
 double hslope = 11.9;
#define hvhalf hvhalf_caLPS
 double hvhalf = -13.4;
#define kpr kpr_caLPS
 double kpr = 31.4;
#define k k_caLPS
 double k = 9.005;
#define mslope mslope_caLPS
 double mslope = -6.7;
#define mvhalf mvhalf_caLPS
 double mvhalf = -8.9;
#define qfact qfact_caLPS
 double qfact = 3;
#define usetable usetable_caLPS
 double usetable = 1;
#define vm vm_caLPS
 double vm = -8.124;
 ...
 "mvhalf_caLPS", &mvhalf_caLPS,
 "mslope_caLPS", &mslope_caLPS,
 "vm_caLPS", &vm_caLPS,
 "k_caLPS", &k_caLPS,
 "kpr_caLPS", &kpr_caLPS,
 "c_caLPS", &c_caLPS,
 "cpr_caLPS", &cpr_caLPS,
 "hvhalf_caLPS", &hvhalf_caLPS,
 "hslope_caLPS", &hslope_caLPS,
 "htau_caLPS", &htau_caLPS,
 "a_caLPS", &a_caLPS,
 "qfact_caLPS", &qfact_caLPS,
 "usetable_caLPS", &usetable_caLPS,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 caLPS /export/home1/users/bssn/serna/HBP/SpineModel/mod/x86_64/caLPS.mod\n");
...
static int _reset;
static char *modelname = "Inactivating HVA L-type calcium channel for nucleus accumbens neuron ";
