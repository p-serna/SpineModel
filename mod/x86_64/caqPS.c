...
#define nrn_init _nrn_init__caqPS
#define _nrn_initial _nrn_initial__caqPS
#define nrn_cur _nrn_cur__caqPS
#define _nrn_current _nrn_current__caqPS
#define nrn_jacob _nrn_jacob__caqPS
#define nrn_state _nrn_state__caqPS
#define _net_receive _net_receive__caqPS 
#define _f_settables _f_settables__caqPS 
#define settables settables__caqPS 
#define states states__caqPS 
...
extern Memb_func* memb_func;
 ...
 "setdata_caqPS", _hoc_setdata,
 "efun_caqPS", _hoc_efun,
 "ghk_caqPS", _hoc_ghk,
 "settables_caqPS", _hoc_settables,
 0, 0
};
#define efun efun_caqPS
#define ghk ghk_caqPS
...
#define mshift mshift_caqPS
 double mshift = 0;
#define mtau mtau_caqPS
 double mtau = 1.13;
#define mslope mslope_caqPS
 double mslope = -6.6;
#define mvhalf mvhalf_caqPS
 double mvhalf = -9;
#define qfact qfact_caqPS
 double qfact = 3;
#define usetable usetable_caqPS
 double usetable = 1;
 ...
 "mvhalf_caqPS", &mvhalf_caqPS,
 "mslope_caqPS", &mslope_caqPS,
 "mtau_caqPS", &mtau_caqPS,
 "mshift_caqPS", &mshift_caqPS,
 "qfact_caqPS", &qfact_caqPS,
 "usetable_caqPS", &usetable_caqPS,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 caqPS /export/home1/users/bssn/serna/HBP/SpineModel/mod/x86_64/caqPS.mod\n");
...
static double _nrn_current(double* _p, Datum* _ppvar, Datum* _thread, _NrnThread* _nt, double _v){double _current=0.;v=_v;{ {
   ica = ghk ( _threadargscomma_ v , cai , cao ) * pcaqbar * m * m ;
   }
 _current += ica;
