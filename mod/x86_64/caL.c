...
#define _f_settables _f_settables__caL 
#define settables settables__caL 
...
#define c c_caL
 double c = 0.0398;
#define htau htau_caL
 double htau = 44.3;
#define hslope hslope_caL
 double hslope = 11.9;
#define hvhalf hvhalf_caL
 double hvhalf = -13.4;
#define kpr kpr_caL
 double kpr = 31.4;
#define k k_caL
 double k = 9.005;
#define mslope mslope_caL
 double mslope = -6.7;
#define mvhalf mvhalf_caL
 double mvhalf = -8.9;
#define qfact qfact_caL
 double qfact = 3;
...
#define vm vm_caL
 ...
 "mvhalf_caL", &mvhalf_caL,
 "mslope_caL", &mslope_caL,
 "vm_caL", &vm_caL,
 "k_caL", &k_caL,
 "kpr_caL", &kpr_caL,
 "c_caL", &c_caL,
 "cpr_caL", &cpr_caL,
 "hvhalf_caL", &hvhalf_caL,
 "hslope_caL", &hslope_caL,
 "htau_caL", &htau_caL,
 "a_caL", &a_caL,
 "qfact_caL", &qfact_caL,
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 5, "cvodeieq");
 	...
 	ivoc_help("help ?1 caL /export/home1/users/bssn/serna/HBP/SpineModel/mod/x86_64/caL.mod\n");
...
static double _nrn_current(double _v){double _current=0.;v=_v;{ {
   ical = mu * ghk ( _threadargscomma_ v , cali , calo ) * pbar * m * m * ( a * h + ( 1.0 - a ) ) ;
   }
 _current += ical;
 ...
 v=_v;
{
  ...
  calo = _ion_calo;
 { error =  states();
 if(error){fprintf(stderr,"at line 65 in file caL.mod:\n    SOLVE states METHOD cnexp\n"); nrn_complain(_p); abort_run(error);}
 } }}
