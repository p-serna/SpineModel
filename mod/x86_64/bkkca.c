...
#define turnOffinact turnOffinact_bkkca
 double turnOffinact = 1;
 /* some parameters have upper and lower limits */
 static HocParmLimits _hoc_parm_limits[] = {
 0,0,0
};
 static HocParmUnits _hoc_parm_units[] = {
 "turnOffinact_bkkca", "1",
 "gkbar_bkkca", "S/cm2",
 "ik_bkkca", "mA/cm2",
 0,0
};
 ...
 "turnOffinact_bkkca", &turnOffinact_bkkca,
 0,0
};
...
extern void _cvode_abstol( Symbol**, double*, int);
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	...
 	ivoc_help("help ?1 bkkca /export/home1/users/bssn/serna/HBP/SpineModel/mod/x86_64/bkkca.mod\n");
 hoc_register_limits(_mechtype, _hoc_parm_limits);
 hoc_register_units(_mechtype, _hoc_parm_units);
 }
static int _reset;
static char *modelname = "BK KCA channel for nucleus accumbens model - old version";
...
double alpha ( _threadargsprotocomma_ double _ltmin , double _ltmax , double _lv , double _lvhalf , double _lk ) {
   double _lalpha;
 _lalpha = q / ( _ltmin + 1.0 / ( 1.0 / ( _ltmax - _ltmin ) + exp ( ( _lv - _lvhalf ) / _lk ) * 1.0 ) ) ;
...
double alp ( _threadargsprotocomma_ double _ltmin , double _lv , double _lvhalf , double _lk ) {
   double _lalp;
 _lalp = q / ( _ltmin + exp ( ( _lv - _lvhalf ) / _lk ) * 1.0 ) ;
