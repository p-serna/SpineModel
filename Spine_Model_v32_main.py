...
with open(folderstore+"All_baseline_datasetv3_"+condition+shflag+".pickle","wb") as f:
...
with open(folderstore+"All_baseline_depinhv3_"+condition+shflag+".pickle","wb") as f:
...
td = 500
vavg,mes,vtracs,vtracsD,vtracsS,Ctracs,me2,me3,_ = simulateSet(model,dis,tG = td,ton = 50,toffset = 70,t_stop = 500, EL = EL0,btsr = ones(9)==1,VDCC = VDCCa)
with open(folderstore+"dis_baselinev3_"+condition+shflag+".pickle","wb") as f:
    pickle.dump([vavg,mes,vtracs,vtracsD,vtracsS,Ctracs],f) 
