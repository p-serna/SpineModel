...
hty = cumsum(ht2[0])/sum(ht2[0])
#htx = concatenate(([mxl[0]],htx,[1.0]))
htx = concatenate(([0],htx))
hty = concatenate(([0],hty))
ax2.plot(htx,hty*myl,'k-',linewidth=2)
ax2.plot(htx,hty*myl,'-',c=color0b,linewidth=2)
...
maxSV = np.max([ht2[1].max(), ht3[1].max()]) 

ax2.set_xlim(0.,maxSV*1.02)
ax1.set_xlim(0.,maxSV*1.02)
...
ax4.vlines(0.0,0.,4.0,linestyle='--')
ax3.vlines(0.0,0.,2.,linestyle='--')
...
ax2.vlines(0.0,0.,4.5,linestyle='--')
ax1.vlines(0.0,0.,2.0,linestyle='--')
